...
public class GetExpression {
	...
	public void buildBTree() {
		...
		if (num == 1) {
			lchild = new GetResult(String.valueOf(ToolDemo.getNumber(40)), null, null);
			rchild = new GetResult(String.valueOf(ToolDemo.getNumber(40)), null, null);
			...
			for (int i = 0; i < place.length; i++) {
				if (place[i]) {
					lnode = new GetResult(String.valueOf(ToolDemo.getNumber(40)), null, null);
					rnode = new GetResult(String.valueOf(ToolDemo.getNumber(40)), null, null);
					if (i % 2 == 0) {
